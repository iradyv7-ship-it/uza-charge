...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      operator_for_charger: { Args: { _charger_id: string }; Returns: string };
      operator_for_connector: {
        Args: { _connector_id: string };
        Returns: string;
      };
      operator_for_payment: { Args: { _payment_id: string }; Returns: string };
      operator_for_session: { Args: { _session_id: string }; Returns: string };
      operator_for_station: { Args: { _station_id: string }; Returns: string };
      pgp_armor_headers: {
        Args: { "": string };
      ...
      start_charging_session: {
        Args: {
          ...
          _driver_id: string;
          _start_method: string;
          _vin?: string;
        };
        Returns: Database["public"]["CompositeTypes"]["start_session_result"];
        SetofOptions: {
          from: "*";
          to: "start_session_result";
          isOneToOne: true;
          isSetofReturn: false;
        };
      };
    ...
    Enums: {
      app_role: "driver" | "operator" | "admin" | "investor" | "regulator" | "battery_passport";
    };
    CompositeTypes: {
      start_session_result: {
        session: Database["public"]["Tables"]["sessions"]["Row"] | null;
        already_charging: boolean | null;
      };
    };
  };
};
